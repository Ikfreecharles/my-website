...
:::info
For HTML implementations, there is no need to install the `@vercel/speed-insights` package.
:::
...
Learn more about the `beforeSend` function in the Vercel Speed Insights documentation.
...
After a few days of visitors, you'll be able to start exploring your metrics. For more information on how to use Speed Insights, see the Vercel Speed Insights documentation.
